// RUN: dataflow-scheduler-opt -allow-unregistered-dialect %s -parallelize-loops-across-instances | dataflow-scheduler-opt -allow-unregistered-dialect | FileCheck %s

// Verify the transformed output parses cleanly through dataflow-scheduler-opt again
// and prints the same structure.
