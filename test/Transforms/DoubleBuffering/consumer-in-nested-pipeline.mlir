...
// Consumer transfer is deeply nested inside a sibling stage's nested pipeline.

// CHECK-LABEL:   func.func @consumer_nested(
...
func.func @consumer_nested(%src: memref<64xf16, #ktdp.spyre_memory_space<HBM>>,
