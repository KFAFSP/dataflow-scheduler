...
// CHECK-NEXT:                     ktdf.data_transfer from %[[PRIVATE_0]]#0{{\[}}%[[DIVSI_4]], %[[DIVSI_5]], %[[CONSTANT_0]]] size [1, 1, 64] to %[[PRIVATE_1]]#0{{\[}}%[[CONSTANT_0]]] size [64] : memref<2x1x64xf16, "L1">, memref<64xf16, "SFU_REG">
...
// CHECK-NEXT:                     ktdf.data_transfer from %[[PRIVATE_0]]#1{{\[}}%[[DIVSI_6]], %[[DIVSI_7]], %[[CONSTANT_0]]] size [1, 1, 64] to %[[PRIVATE_1]]#1{{\[}}%[[CONSTANT_0]]] size [64] : memref<2x1x64xf16, "L1">, memref<64xf16, "SFU_REG">
// CHECK-NEXT:                   }
...
// CHECK-NEXT:                     ktdf.data_transfer from %[[PRIVATE_1]]#2{{\[}}%[[CONSTANT_0]]] size [64] to %[[PRIVATE_0]]#2{{\[}}%[[DIVSI_8]], %[[DIVSI_9]], %[[CONSTANT_0]]] size [1, 1, 64] : memref<64xf16, "SFU_REG">, memref<2x1x64xf16, "L1">
// CHECK-NEXT:                   }
// CHECK-NEXT:                 }
// CHECK-NEXT:               } {loop_type = #ktdf.loop_type<parallel_loop>}
// CHECK-NEXT:             } {loop_type = #ktdf.loop_type<parallel_loop>}
